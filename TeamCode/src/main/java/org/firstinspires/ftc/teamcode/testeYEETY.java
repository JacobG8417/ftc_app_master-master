 ...
 */
@com.qualcomm.robotcore.eventloop.opmode.TeleOp(name="Mecanum Telelol Op", group="TeleOp")
public class testeYEETY extends OpMode {
    ...
    public static void arcadeMecanum(double y, double x, double c, DcMotor leftFront, DcMotor rightFront, DcMotor leftBack, DcMotor rightBack) {
        ...
        front_left.setPower(leftFrontVal*scaledPower+leftFront.getPower()*(1-scaledPower));
        back_left.setPower(rightFrontVal*scaledPower+rightFront.getPower()*(1-scaledPower));
        front_right.setPower(leftBackVal*scaledPower+leftBack.getPower()*(1-scaledPower));
        back_right.setPower(rightBackVal*scaledPower+rightBack.getPower()*(1-scaledPower));
    }
}
/*© 2019 GitHub, Inc.
        Terms
