 ...
 */
@com.qualcomm.robotcore.eventloop.opmode.TeleOp(name="i hate life", group="TeleOp")
public class Teleoptest extends OpMode {
    ...
    public void loop() {
        ...
        double inputC = Math.abs(gamepad1.right_stick_x)> ACCEPTINPUTTHRESHOLD ? -gamepad1.right_stick_y: 0;
